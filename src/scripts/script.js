...
function showDetail() {
  Swal.fire({
    ...
    html: `
      ...
      <img class="image" src="${this.parentElement.parentElement.querySelector('.thumb-res').src}" alt="gambar  class="lazyload" ${this.parentElement.querySelector('.title-res').textContent}" style="width: 100%; margin-bottom: 10px;" crossorigin="anonymous">
      <div class="info">
